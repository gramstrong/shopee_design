		...
		$.get('https://api.rss2json.com/v1/api.json', data, function(response) {
            ...
            if (response.status === 'ok') {
				...
				$.each(response.items, function(k, item) {
					...
					output += '<a class="card" href="'+ item.link + '" target="_blank"><div class="crop"><img src="' + src + '" /></div>';
    	...
    	<div className='container'>
    		<div className='jumbotron'>
    			<div className='jumbotron-header'>
    				<span className="jumbotron-brandname">Shopee Design</span> exists to enhance<br/> user experience & work efficiency
    			</div>
   				{/* <div className="jumbotron-img">
                    <P5Wrapper sketch={sketch} />
                </div> */}
                <img src="/static/image/web.svg" alt="" className="web"/>
